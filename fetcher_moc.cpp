...
const QMetaObjectExtraData Fetcher::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Fetcher::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Fetcher,
      qt_meta_data_Fetcher, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Fetcher::getStaticMetaObject() { return staticMetaObject; }
